...
<template>
    <Head title="Nuevo Servicio Adicional" />

    <AdminLayout title="Nuevo Servicio Adicional">
        <!-- Breadcrumb -->
        ...
        <div class="mx-auto max-w-2xl">
            <form @submit.prevent="submit" class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm space-y-4">
                <div>
                    ...
                    <TextInput id="name" v-model="form.name" type="text" class="mt-1 block w-full" required placeholder="Ej: Hora extra - Norteño" />

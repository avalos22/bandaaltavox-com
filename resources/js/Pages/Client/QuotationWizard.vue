        ...
        <div class="mx-auto max-w-3xl">
            <form @submit.prevent="submit">
                    ...
                    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            ...
                            >
                                ...
                                <p class="text-lg font-bold text-amber-600">{{ formatPrice(pkg.price) }}</p>
                ...
                <div v-show="step === 3" class="space-y-6">
                    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                        <h3 class="text-base font-semibold text-gray-800 mb-1">Servicios adicionales</h3>
                        <p class="text-sm text-gray-500 mb-4">Selecciona los extras que desees agregar (opcional)</p>

                        <div v-for="(catAddons, category) in groupedAddons" :key="category" class="mb-6 last:mb-0">
                    ...
                    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                        ...
                        <div class="divide-y divide-gray-100">
                            <div v-for="item in buildItems()" :key="item.description" class="flex items-center justify-between py-3">
                                ...
                                <p class="text-sm font-semibold text-gray-700">{{ formatPrice(item.quantity * item.unit_price) }}</p>
                            </div>
                        </div>
